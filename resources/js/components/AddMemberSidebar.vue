      ...
      <div class="row">
        <div class="col-12">
          ...
          <form  class="form-horizontal" action="/api" v-on:submit.prevent="onSubmit" method="post">
            ...
            <div class="form-group">
              <h4 v-text="$ml.get('sidebar.form.subtitle_2')"></h4>
              <hr>
                ...
                <div class="col-6">
                  <div class="help" :class="{active: info.support.market}">
                    <label for="sm_market" >
                      ...
                      <input type="checkbox" name="support[]" v-model="info.support.market" id="sm_market" value="market">
                    </label>
                  </div>
                </div>
                <div class="col-6">
                  <div class="help" :class="{active: info.support.food}">
                    <label for="sm_food">
                      ...
                      <input type="checkbox" name="support[]" v-model="info.support.food" id="sm_food" value="food">
                    </label>
                  </div>
                </div>
                <div class="col-6">
                  <div class="help" :class="{active: info.support.talk}">
                    <label for="sm_talk">
                      ...
                      <input type="checkbox" name="support[]" v-model="info.support.talk" id="sm_talk" value="talk">
                    </label>
                  </div>
                </div>
                <div class="col-6">
                  <div class="help" :class="{active: info.support.health}">
                    <label for="sm_health">
                      ...
                      <input type="checkbox" name="support[]" v-model="info.support.health" id="sm_health" value="health">
                    </label>
                  </div>
                </div>
                <div class="col-6">
                  <div class="help" :class="{active: info.support.dog}">
                    <label for="sm_dog">
                      ...
                      <input type="checkbox" name="support[]" v-model="info.support.dog" id="sm_dog" value="dog">
                    </label>
                  </div>
                </div>
                <div class="col-12">
            ...
            <div class="form-group extra-bottom">
              <label class="check_truth checklabel" for="sm_veracidade">
                <input type="checkbox" id="sm_veracidade" name="support[]" v-model="info.support.veracidade" value="">
